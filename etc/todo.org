...
** TODO in consensus manager drop message not originating from current leader
** TODO shutdown the 'ping' and 'recovery' threads
...
** TODO implement received message dropping from dead nodes
